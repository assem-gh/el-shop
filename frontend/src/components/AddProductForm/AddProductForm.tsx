...
import { createNewProduct } from "../../api/axios";
        ...
        return (
            <form onSubmit={form.onSubmit(handleSubmit)}>
                <Paper withBorder p="md" radius="md">
                    <TextInput label="Product name" placeholder="Abc 12345 "
                    ...
                    <Dropzone mt="md" accept={IMAGE_MIME_TYPE} onDrop={(v) => setFiles(prev => [...prev, ...v])}>
                    ...
                    <Button type="submit" my="md" fullWidth>Submit</Button>
                </Paper>
            </form>
        );
    }
